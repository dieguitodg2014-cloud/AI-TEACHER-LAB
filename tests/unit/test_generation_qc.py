    ...
    def test_teacher_execution_semantic_alignment(self):
        lesson = {
            ...
            "teacher_execution": {
                ...
                "language_bank": ["You should ..."],
                "teacher_talk": ["Give one piece of advice."],
                "ccqs": ["Is this advice?"],
                "examples": ["You should rest."],
                "scaffolding": [],
                "materials": [],
                "role_cards": ["Student A gives advice."],
                "assessment_checklist": ["Uses should."],
                "common_errors": {},
                "worksheet": {},
                "answer_key": {},
                "exit_ticket": {},
...
if __name__ == "__main__":
    ...
    def test_teacher_execution_semantic_alignment(self):
        ...
        result = review_generated_lesson(
            lesson, level="A2", objective="Give advice", duration_minutes=90, topic="should"
        )
        self.assertEqual(result["status"], "READY")
